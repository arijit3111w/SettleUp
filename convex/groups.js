...
export const getGroupExpenses = query({
  ...
  handler: async (ctx, { groupId }) => {
    ...
    //create a 2d ledgre to track who owes whom
    //ledger[A][B] = how much A owes to B
    ...
    for (const exp of expenses) {
      ...
      for (const split of exp.splits) {
        ...
        // update : increase payer's balance, decrease debtor's balance
        totals[payer] += amt; //payer gains amt
        totals[debtor] -= amt; // debtor loses amt
    ...
    // }
    //
    // This means user2 now owes user1 only $10,
    // and user3 still owes user1 $20
